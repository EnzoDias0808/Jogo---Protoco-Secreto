# PROTOCOLO-SECRETO
> **Status:** Criamos a Tela de Inicio/Login/Cadastro/Inicial do jogo em si
> **Data:** 12/06/2026
## Problema
Tirar o tédio das pessoas, com suspense e investigação.
## Solução
...
3. Engenharia Social e Invasão de E-mails
4. Senhas Escondidas Antravés de Pistas
5. Monitoramento de Suspeitos
## Diferencial competitivo
Connseguir Acessar as Redes Sociais Dele.
...
| Nome | Papel (Inovação) |
|------|------------------|
| ENZO DIAS |  Product Manager/Scrum Master |
| EMANUELI  | Documentação/QA |
| EMILLY    | Front-End |
| JULIO     | Back-end |
